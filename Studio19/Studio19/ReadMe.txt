...
5. If we have too many unique visitors, when we add a new file type, we not only have to add an accept method in the abstract file class, but also have to add a lot of visit_<new type> methods
in the these visitors in total(1 for each).